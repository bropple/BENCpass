// GENERATED by tools/vendor-psl.sh — do not edit.
// Public Suffix List, 10239 rules, retrieved 2026-08-16.
// Mozilla Public License 2.0: https://publicsuffix.org/list/
//
// Refresh occasionally. A stale list is not a security hole — an unknown
// suffix degrades to treating the last two labels as the site, which is
// conservative — but new TLDs will match more loosely than they should.
